...
def display_results(result):
    ...
    with m3:
        st.metric("Cost Estimate", metadata.get('costEstimate', '$0.008'))
...
with tab3:
    ...
    <div class="about-feature"><i class="fas fa-rupee-sign"></i> Cost-efficient inference (&lt;$0.01 per document)</div>
